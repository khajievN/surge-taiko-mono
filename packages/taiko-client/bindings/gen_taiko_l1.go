...
//
// Solidity: function getConfig() view returns((uint64,uint64,uint64,uint64,uint32,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint64),uint64))
